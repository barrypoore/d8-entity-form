...
/**
 * Provides routes for Marquee entities.
 *
 * @see Drupal\Core\Entity\Routing\AdminHtmlRouteProvider
 * @see Drupal\Core\Entity\Routing\DefaultHtmlRouteProvider
 */
class marqueeHtmlRouteProvider extends AdminHtmlRouteProvider {
  ...
  protected function getCollectionRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('collection') && $entity_type->hasListBuilderClass()) {
      ...
      $route
        ...
        ->setRequirement('_permission', 'view marquee entities')
  ...
  protected function getAddFormRoute(EntityTypeInterface $entity_type) {
    if ($entity_type->hasLinkTemplate('add-form')) {
      ...
      $route
        ->setDefaults([
          '_controller' => 'Drupal\create_supplier\Controller\marqueeAddController::addForm',
          '_title_callback' => 'Drupal\create_supplier\Controller\marqueeAddController::getAddFormTitle',
        ])
  ...
  protected function getAddPageRoute(EntityTypeInterface $entity_type) {
    ...
    $route
      ->setDefaults([
        '_controller' => 'Drupal\create_supplier\Controller\marqueeAddController::add',
  ...
  protected function getSettingsFormRoute(EntityTypeInterface $entity_type) {
    if (!$entity_type->getBundleEntityType()) {
      ...
      $route
        ->setDefaults([
          '_form' => 'Drupal\create_supplier\Form\marqueeSettingsForm',

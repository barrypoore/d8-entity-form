...
class MyForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['marquees']['framed_marquees']['framed_marquee_20ft']['20x20_marquee-no-lining_price']['20x20_marquee_price_additional_10ft'] = array(
        '#type' => 'textfield',
    ...
    $form['marquees']['framed_marquees']['framed_marquee_20ft']['20x20_marquee_lining_price']['20x20_marquee_lining_price'] = array(
        '#type' => 'textfield',
        '#title' => $this->t('[Base Price] 20x20ft / 6x6m Lining Price'),
      );

    $form['marquees']['framed_marquees']['framed_marquee_20ft']['20x20_marquee_lining_price']['20x20_marquee_lining_price_additional_10ft'] = array(
        '#type' => 'textfield',
    ...
    $form['marquees']['framed_marquees']['framed_marquee_20ft']['20x20_marquee-matting_price']['20x20_marquee_matting_price'] = array(
      '#type' => 'textfield',
      '#title' => $this->t('[Base Price] 20x20ft / 6x6m Matting Price'),
    );

    $form['marquees']['framed_marquees']['framed_marquee_20ft']['20x20_marquee-matting_price']['20x20_marquee_matting_price_additional_10ft'] = array(
      '#type' => 'textfield',
    ...
    $form['marquees']['framed_marquees']['framed_marquee_20ft']['20x20_marquee-carpet_price']['20x20_marquee_carpet_price'] = array(
        '#type' => 'textfield',
        '#title' => $this->t('[Base Price] 20x20ft / 6x6m Carpet Price'),
      );

    $form['marquees']['framed_marquees']['framed_marquee_20ft']['20x20_marquee-carpet_price']['20x20_marquee_carpet_price_additional_10ft'] = array(
        '#type' => 'textfield',
    ...
    $form['marquees']['trapeze_capri_marquees_fieldset']['trapeze_capri_size_small_fieldset']['small_price_for_one_trapeze_capri_fieldset']['small_capri_trapeze_price'] = array(
      '#type' => 'textfield',
      '#title' => $this->t('Base Price for 1 Small Capri / Trapeze '),
    );

    $form['marquees']['trapeze_capri_marquees_fieldset']['trapeze_capri_size_small_fieldset']['small_price_for_one_trapeze_capri_fieldset']['additional_small_capri_trapeze_price'] = array(
      '#type' => 'textfield',
    ...
    $form['marquees']['trapeze_capri_marquees_fieldset']['trapeze_capri_size_small_fieldset']['small_matting_trapeze_capri_fieldset']['small_base_matting_capri_trapeze_price'] = array(
      '#type' => 'textfield',
      '#title' => $this->t('Base Matting Price for a Small Capri / Trapeze'),
    );

    $form['marquees']['trapeze_capri_marquees_fieldset']['trapeze_capri_size_small_fieldset']['small_matting_trapeze_capri_fieldset']['small_additional_base_matting_capri_trapeze_price'] = array(
      '#type' => 'textfield',
    ...
    $form['marquees']['trapeze_capri_marquees_fieldset']['trapeze_capri_size_small_fieldset']['small_carpet_trapeze_capri_fieldset']['small_base_carpet_capri_trapeze_price'] = array(
      '#type' => 'textfield',
      '#title' => $this->t('Base Carpet Price for a Small Trapeze / Capri'),
    );

    $form['marquees']['trapeze_capri_marquees_fieldset']['trapeze_capri_size_small_fieldset']['small_carpet_trapeze_capri_fieldset']['small_additional_carpet_capri_trapeze_price'] = array(
      '#type' => 'textfield',
    ...
    $form['marquees']['trapeze_capri_marquees_fieldset']['trapeze_capri_size_small_fieldset']['small_uplighter_price_trapeze_capri_fieldset']['small_how_many_uplighters_capri_trapeze_price'] = array(
      '#type' => 'textfield',
    ...
    $form['marquees']['trapeze_capri_marquees_fieldset']['trapeze_capri_size_small_fieldset']['small_chandelier_price_trapeze_capri_fieldset']['small_chandalier_capri_trapeze_price'] = array(
      '#type' => 'textfield',
...
//    ]);
    ...
    $marquee = marquee::create([
      'type' => '20ft_framed_marquee',
      'name' => 'Frame Marquee',
      'field_additional_bay_20ft' => $form_state->getValue('20x20_marquee_price'),
      'field_20ft_width_base_price' => $form_state->getValue('20x20_marquee_price_additional_10ft')
    ]);

    $marquee->save();

    Drupal_set_message($this->t($form_state->getValue('20x20_marquee_price')));
  }
